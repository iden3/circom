...
static uint64_t     Fr_rawq[] = {0xffffffff00000001, 0};
static FrRawElement Fr_rawR2  = {0xfffffffe00000001};
...
void Fr_rawMMul(FrRawElement pRawResult, const FrRawElement pRawA, const FrRawElement pRawB)
{
    ...
    c += mpn_addmul_1(product0, mq, N, np0);

    mpn_copyi(pRawResult,  product0+1, Fr_N64);
