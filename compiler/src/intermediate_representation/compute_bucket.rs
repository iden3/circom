...
use code_producers::llvm_elements::{LLVMInstruction, LLVMContext, LLVMAdapter, to_basic_metadata_enum, to_enum, LLVMIRProducer};
...
use code_producers::llvm_elements::instructions::{create_add_with_name, create_call, create_mul, create_mul_with_name};
